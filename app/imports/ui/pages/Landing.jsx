    ...
    return (
        <Grid rows={'equal'}>
          <Grid.Row style={{ margin: 50 }}>
              <Grid.Column width={8} style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                  <b style={{ color: '#0B2C52', fontSize: 30, alignSelf: 'flex-start', paddingLeft: 20, marginBottom: 15 }}>Welcome to HACC-Hui</b>
          ...
          <Grid.Row style={{ backgroundColor: '#E5F0FE' }}>
            <Grid.Column width={8} centered style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', alignItems: 'center' }}>
